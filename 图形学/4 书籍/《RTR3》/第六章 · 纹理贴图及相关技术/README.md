![[图形学/4 书籍/《RTR3》/第六章 · 纹理贴图及相关技术/media/title.jpg]]
...
-   平面投影（The planar projection）。平面投影非常类似于x-射线幻灯片投影，它沿着一个方向进行投影，并将纹理应用到物体的所有表面上。这种方法通常使用正交投影，用来将纹理图应用到人物上，其把模型看作一个用纸做的娃娃，将不同的纹理粘贴到该模型的前后。
    ...
    ![[22da2f6ff8dcb49f33d3d6fc0d79af95.jpg|https://pic1.zhimg.com/50/v2-b253e752bfd526af39473d731bd6b32e_hd.jpg]]
    图6
